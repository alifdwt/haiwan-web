...
export function FormProduct({ onSubmit, submitting }: { onSubmit: (values: ProductFormValues) => void; submitting: boolean }) {
                ...
                <div>
                    {fields.map((field, index) => (
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel className={cn(index === 0 ? "" : "sr-only")}>Image</FormLabel>
                                    <FormControl>
